Статут Проекту: GHEADS PDCA Platform
...
Дані таблиці доступні виключно внутрішній команді GHEADS і забезпечують контроль якості та фінансів.
...
-- Ізольована воронка внутрішніх продажів GHEADS (Agency CRM)
