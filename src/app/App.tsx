...
type Role = 'client' | 'cs_manager' | 'admin';
  ...
  return (
    <div className="fixed bottom-5 right-5 z-[9999]">
      <div className="relative">
        {open && (
          <div className="absolute bottom-full right-0 mb-2 bg-[#181818] border border-border rounded-xl shadow-2xl overflow-hidden min-w-[180px]">
...
function AdminApp() {
  ...
  const PAGE_LABELS: Record<AdminTab, string> = {
    overview: 'Agency Overview', clients: 'Clients & 360°', crm: 'Agency CRM', pdca: 'PDCA Matrix', users: 'Users', settings: 'Settings',
  };
...
function ManagerApp() {
  ...
  const PAGE_LABELS: Record<ManagerTab, string> = {
    dashboard: 'My Dashboard', clients: 'Client 360°', leads: 'Leads Workspace', pdca: 'PDCA',
  };
