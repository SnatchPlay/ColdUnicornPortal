...
| Default timeframe | **Current month** (`DEFAULT_TIMEFRAME_PRESET` / `createDefaultTimeframe()`) | [timeframe.ts](../../../src/app/lib/timeframe.ts) | Loaded into pages on first render. |
| Default timeframe on **Leads** | **All time** (`LEADS_DEFAULT_TIMEFRAME_PRESET`), every role | [timeframe.ts](../../../src/app/lib/timeframe.ts), [leads-page.tsx](../../../src/app/pages/leads-page.tsx), [client-leads-page.tsx](../../../src/app/pages/client-leads-page.tsx) | The leads list is a working CRM surface, not a period report: a month-shaped default hid older open leads behind a filter nobody had set. A missing or retired `?range` on Leads degrades to All time, not to the current month. |
